...
public class LabyrinthHelper {
    ...
    private void swapWithBlankRoom(LabyrinthRoom labyrinthRoom){
        ...
        labyrinthRoom.setXLocation((long) xBlank);
        labyrinthRoom.setYLocation((long) yBlank);
        labyrinthRoom.setZLocation((long) zBlank);
        cube[xNew][yNew][zNew] = cube[xBlank][yBlank][zBlank];
        cube[xBlank][yBlank][zBlank] = labyrinthRoom;
        cube[xNew][yNew][zNew].setXLocation((long) xNew);
        cube[xNew][yNew][zNew].setYLocation((long) yNew);
        cube[xNew][yNew][zNew].setZLocation((long) zNew);
        xBlank = xNew;
        yBlank = yNew;
        zBlank = zNew;
    }
